...
var HTMLprojectImage = '<a class="imgSmall" href="%img%-big.jpg" rel="prettyPhoto"><img src="%data%.jpg"></a>';
...
var HTMLonlineClasses = '<h3 class="courses-title">Online Classes</h3>';
var HTMLonlineTitle = '<a href="%url%">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text date-course">%data%</div>';
